            ...
            >
              <div className=" flex flex-col gap-1.5 w-96">
                ...
                <div className=" flex justify-center items-center gap-1">
                  ...
                  />
                  <div
                    className="group/button overflow-hidden relative font-medium py-1.5 px-6 rounded text-[#fafafa] bg-gradient-to-r from-[#3E64FB] to-[#2C4DCF] w-40 cursor-pointer"
                ...
                {showEnterOTP && (
                  <div className=" flex justify-center items-center gap-1">
                    ...
                    />
                    <div
                      className="group/button overflow-hidden relative font-medium py-1.5 pl-6 pr-8 rounded text-[#fafafa] bg-gradient-to-r from-[#3E64FB] to-[#2C4DCF] cursor-pointer"
